...
MTVertexToPixel MultiTexturedVS(float4 inPos : POSITION, float3 inNormal : NORMAL, int4 inTexWeights : TEXCOORD0)
{
	...
	Output.TextureCoords.x = inPos.x / textureSize;
	Output.TextureCoords.y = inPos.z / textureSize;

	Output.LightDirection.xyz = -xLightDirection;
	Output.LightDirection.w = 1;
	Output.TextureWeights = inTexWeights;
	//Output.TextureWeights /= 255f;
...
technique SimpleTextured
{
	pass Pass0
	{
		VertexShader = compile vs_1_1 STexturedVS();
		PixelShader = compile ps_2_0 STexturedPS();
	}
}
